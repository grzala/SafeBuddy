Feature: register and login
	...
	Scenario: Register and log in
		...
		And fill in "register_username" with "cucumbertest"
	...
	Scenario: Get all register errors
		...
		And fill in "register_password" with "tet"
		And fill in "register_confirm_password" with "tessssatas"
		And fill in "register_email" with "smoke@weedeveryday"
		And submit register form
